    ...
    <div class="owl-carousel owl-carousel-light owl-carousel-light-init-fadeIn owl-theme manual dots-inside dots-horizontal-center show-dots-hover show-dots-xs show-dots-sm show-dots-md full-width nav-inside nav-inside-edge show-nav-hover custom-carousel-arrows-style-1 mb-0" data-plugin-options="{'autoplayTimeout': 7000}" data-dynamic-height="['600px','600px','600px','500px','500px']" style="height: 50vh;">
        <div class="owl-stage-outer">
            <div class="owl-stage">
                ...
                <!-- Carousel Slide 1 -->
                <div class="owl-item position-relative overflow-hidden" style="background-image:  url(img/gallery/competitions/16/0.jpeg); background-size: cover; background-position: 60% 40%; background-position: 60% 40%;">
                        ...
                        <div class="row align-items-center justify-content-center h-100">
                            <div class="col-lg-7">
                                <div class="d-flex flex-column justify-content-center align-items-center text-center h-100">
                                    ...
                                    {{transex('Etapa')}} 4 Lugoj 11-12 Iunie
                                    </span>
                                    ...
                                    <a href="{{url('/clasamentdata/2022-06-11')}}" class="btn btn-primary font-weight-bold btn-py-2 btn-px-4 " data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1250">{{transex('Vezi mai mult')}}</a> 
                ...
                <div class="owl-item position-relative overflow-hidden" style="background-image:  url(img/gallery/competitions/16/4.jpeg); background-size: cover; background-position: 60% 40%; background-position: 60% 40%;">
                    <div class="container position-relative z-index-3 h-100">
                        <div class="row align-items-center justify-content-center h-100">
                            <div class="col-lg-7">
                                <div class="d-flex flex-column justify-content-center align-items-center text-center h-100">
					...
					<div class="container">
						...
						<div class="row justify-content-center text-center">
							...
							<div class="col-lg-4 col-sm-8">
                                ...
                                <a href="{{url('/linkuri')}}" class="text-decoration-none "><strong>{{transex('Linkuri utile')}}</strong><p class="custom-text-color-2">{{transex('O lista de linkuri catre situri utile pentru tirul vanatoresc')}}</p></a>
							</div>
						</div>
					</div>
				</section>
