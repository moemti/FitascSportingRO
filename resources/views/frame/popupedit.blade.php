    ...
    <div class="modal-dialog"  id="popupDialog-content" >
        <div class="modal-content panel-primary" style="overflow: scroll;">
            ...
            <div class="modal-footer" id="popup_footer">
                <input id="btnPopupCloseModal" type="button" data-dismiss="modal" aria-hidden="true" class="btn btn-primary btn-sm" value="Inchide">
                <input id="btnPopupSaveModal" type="button" aria-hidden="true" class="btn btn-primary btn-sm" value="Salveaza">
            </div>
